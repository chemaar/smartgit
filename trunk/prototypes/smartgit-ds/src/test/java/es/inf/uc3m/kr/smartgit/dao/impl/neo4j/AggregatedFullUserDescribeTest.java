...
public class AggregatedFullUserDescribeTest {

	protected static Logger logger = Logger.getLogger(AggregatedFullUserDescribeTest.class);
	...
	public AggregatedFullUserDescribeTest(){
		this.initCommitDAO();
